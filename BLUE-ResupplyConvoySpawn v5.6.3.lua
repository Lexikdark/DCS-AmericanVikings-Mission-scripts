...
ConvoySystem.updateInterval = 12     -- Check convoys every 12 seconds (reduced server load)
...
ConvoySystem.destinationZones = {
    {name = "KANDAHAR", fullName = "KANDAHAR", zoneName = "KANDAHAR_Spawn"},
    {name = "BAGRAM", fullName = "BAGRAM", zoneName = "BAGRAM_Spawn"},
    {name = "KABUL", fullName = "KABUL", zoneName = "KABUL_Spawn"},
    {name = "JALALABAD", fullName = "JALALABAD", zoneName = "JALALABAD_Spawn"},
    ...
    {name = "FOB_URGOON", fullName = "Urgoon Heliport", zoneName = "FOB_URGOON_Spawn"},
    {name = "TARINKOT", fullName = "TARINKOT", zoneName = "TARINKOT_Spawn"},
    {name = "CHAGHCHARAN", fullName = "CHAGHCHARAN", zoneName = "CHAGHCHARAN_Spawn"}
}

-- Spawn zones (must match trigger zones in mission)
ConvoySystem.spawnZones = {
    KANDAHAR = "KANDAHAR_Spawn",
    BAGRAM = "BAGRAM_Spawn",
    KABUL = "KABUL_Spawn",
    JALALABAD = "JALALABAD_Spawn",
    ...
    TARINKOT = "TARINKOT_Spawn",
    CHAGHCHARAN = "CHAGHCHARAN_Spawn",
}
